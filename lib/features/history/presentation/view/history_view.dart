...
class JobHistoryView extends ConsumerStatefulWidget {
  const JobHistoryView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _JobHistoryViewState();
}

class _JobHistoryViewState extends ConsumerState<JobHistoryView> {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: const Icon(Icons.arrow_forward_ios,
                            color: Colors.brown),
                        onTap: () {
                          // Navigate to job details or perform another action
                        },
                      ),
                    );
                  },
